...
$stmt = $pdo->prepare("SELECT * FROM produit ORDER BY prix LIMIT :limit_min, 25");
...
<center><a href='tri_boutique_prix.php?limit=<?php echo $limitMin; ?>'>page précédente</a> ||| <a href='tri_boutique_prix.php?limit=<?php echo $limitMax; ?>'>page suivante</a></center>