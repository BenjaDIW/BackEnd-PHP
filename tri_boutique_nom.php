...
$stmt = $pdo->prepare("SELECT * FROM produit ORDER BY nom LIMIT :limit_min, 25");
...
<center><a href='tri_boutique_nom.php?limit=<?php echo $limitMin; ?>'>page précédente</a> ||| <a href='tri_boutique_nom.php?limit=<?php echo $limitMax; ?>'>page suivante</a></center>