  ...
  <body>
    ...
    <nav class="mb-4 responsive navbar navbar-expand-lg navbar-light">
      ...
      >
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link text-primary font-weight-bold" href="index_admin.php"><?php echo ucfirst(LANGUE["accueil"]); ?></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link text-primary font-weight-bold" href="connexion.php"><?php echo ucfirst(LANGUE["se_connecter"]); ?></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <a class="nav-link text-dark font-weight-bold" href="BO.php">Back Office</a>
          </li>
          </li>
            <li class="nav-item">
