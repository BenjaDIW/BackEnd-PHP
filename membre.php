...
$stmtAdresse->bindParam(':idclient', $_SESSION['idclient']);
$stmtAdresse->execute();
...
$stmtLibelle->bindParam(':idclient', $_SESSION['idclient']);
$stmtLibelle->execute();
...
$stmtAVG->bindParam(':idclient', $_SESSION['idclient']);
$stmtAVG->execute();
...
<div class="text-center" action="membre.php" method="GET">
